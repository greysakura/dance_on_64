...
if __name__ == "__main__":
    ...
    RBO_reranking_result_dir = top_dir + 'RBO_reranking/'
    ...
    negative_count = []
    positive_total = []
    output_file = open(query_goto_dir + 'evaluation_ranking_verification.txt', 'w')
    ...
    for query_i in range(len(target_img_dir_list)):
        ...
        tmp_result_file = open(RBO_reranking_result_dir + target_img_dir_list[query_i].split('.')[0] + '_RBO_reranking.txt', 'r')
    ...
    positive_or_not_file = open(top_dir + 'positive_or_not_RV.csv', 'w')
