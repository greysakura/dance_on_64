...
if __name__ == "__main__":
    ...
    negative_count = []
    positive_total = []
    output_file = open(query_goto_dir + 'evaluation_IR_SVM.txt', 'w')
    ...
    for query_i in range(len(target_img_dir_list)):
        ...
        tmp_result_file = open(IR_SVM_dir + target_img_dir_list[query_i].split('.')[0] + '_IR_SVM.txt', 'r')
    ...
    positive_or_not_file = open(top_dir + 'positive_or_not_IR_SVM.csv', 'w')
